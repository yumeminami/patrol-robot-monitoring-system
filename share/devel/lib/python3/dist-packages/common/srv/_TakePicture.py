...
"""autogenerated by genpy from common/TakePictureRequest.msg. Do not edit."""
import codecs
import sys
...
class TakePictureRequest(genpy.Message):
  _md5sum = "abb202ce41f595a07dc3199477972edd"
  _type = "common/TakePictureRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string take_picture
"""
  __slots__ = ['take_picture']
  _slot_types = ['string']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.take_picture = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.take_picture = str[start:end]
      return self
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from common/TakePictureResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class TakePictureResponse(genpy.Message):
  _md5sum = "9043ad6543908764c35c3fb41997ccd4"
  _type = "common/TakePictureResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
string frame_id
"""
  __slots__ = ['img','status_code','err_msg']
  _slot_types = ['sensor_msgs/Image','int32','string']
...
class TakePicture(object):
  _type          = 'common/TakePicture'
  _md5sum = '5810510cbe479584b13b0db4c9da21a6'
