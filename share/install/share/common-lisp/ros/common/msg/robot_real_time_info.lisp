...
(cl:defclass <robot_real_time_info> (roslisp-msg-protocol:ros-message)
  ((velocity
    :reader velocity
    :initarg :velocity
    :type cl:float
...
(cl:defclass robot_real_time_info (<robot_real_time_info>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <robot_real_time_info>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'robot_real_time_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common-msg:<robot_real_time_info> is deprecated: use common-msg:robot_real_time_info instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <robot_real_time_info>))
...
(cl:defmethod position-val ((m <robot_real_time_info>))
...
(cl:defmethod position_control_state-val ((m <robot_real_time_info>))
...
(cl:defmethod battery_state-val ((m <robot_real_time_info>))
...
(cl:defmethod battery_level-val ((m <robot_real_time_info>))
  ...
  (battery_level m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <robot_real_time_info>) ostream)
  "Serializes a message object of type '<robot_real_time_info>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <robot_real_time_info>) istream)
  "Deserializes a message object of type '<robot_real_time_info>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<robot_real_time_info>)))
  "Returns string type for a message object of type '<robot_real_time_info>"
  "common/robot_real_time_info")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'robot_real_time_info)))
  "Returns string type for a message object of type 'robot_real_time_info"
  "common/robot_real_time_info")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<robot_real_time_info>)))
  "Returns md5sum for a message object of type '<robot_real_time_info>"
  "3b8aa7073ad1bc4871cf8c840555bf9c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'robot_real_time_info)))
  "Returns md5sum for a message object of type 'robot_real_time_info"
  "3b8aa7073ad1bc4871cf8c840555bf9c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<robot_real_time_info>)))
  "Returns full string definition for message of type '<robot_real_time_info>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'robot_real_time_info)))
  "Returns full string definition for message of type 'robot_real_time_info"
  (cl:format cl:nil "float32 velocity                #运动速度~%float32 position                #当前位置~%int32 position_control_state    #位置控制状态：0 未完成 1 完成~%int32 battery_state             #电池充电状态：0 代表充电 1 代表未充电~%int32 battery_level             #电池电量(0-100)~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <robot_real_time_info>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <robot_real_time_info>))
  "Converts a ROS message object to a list"
  (cl:list 'robot_real_time_info
