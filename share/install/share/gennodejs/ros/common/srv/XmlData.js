...
class XmlDataRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type XmlDataRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type XmlDataRequest
    let len;
    let data = new XmlDataRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new XmlDataRequest(null);
...
class XmlDataResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type XmlDataResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type XmlDataResponse
    let len;
    let data = new XmlDataResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new XmlDataResponse(null);
...
module.exports = {
  Request: XmlDataRequest,
  Response: XmlDataResponse,
  md5sum() { return 'c5819519b16be731a77f3869f8987fe2'; },
  datatype() { return 'common/XmlData'; }
};
