...
(cl:defmethod cl:initialize-instance :after ((m <position_command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_interfaces-msg:<position_command> is deprecated: use ros_interfaces-msg:position_command instead.")))

(cl:ensure-generic-function 'position_control_type-val :lambda-list '(m))
(cl:defmethod position_control_type-val ((m <position_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interfaces-msg:position_control_type-val is deprecated.  Use ros_interfaces-msg:position_control_type instead.")
  (position_control_type m))

(cl:ensure-generic-function 'target_position_f-val :lambda-list '(m))
(cl:defmethod target_position_f-val ((m <position_command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interfaces-msg:target_position_f-val is deprecated.  Use ros_interfaces-msg:target_position_f instead.")
  (target_position_f m))

(cl:ensure-generic-function 'velocity_f-val :lambda-list '(m))
(cl:defmethod velocity_f-val ((m <position_command>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<position_command>)))
  ...
  "ros_interfaces/position_command")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'position_command)))
  "Returns string type for a message object of type 'position_command"
  "ros_interfaces/position_command")
