...
(cl:defmethod cl:initialize-instance :after ((m <gimbal_control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'gimbal_control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_interfaces-msg:<gimbal_control> is deprecated: use ros_interfaces-msg:gimbal_control instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <gimbal_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interfaces-msg:command-val is deprecated.  Use ros_interfaces-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'preset_index-val :lambda-list '(m))
(cl:defmethod preset_index-val ((m <gimbal_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_interfaces-msg:preset_index-val is deprecated.  Use ros_interfaces-msg:preset_index instead.")
  (preset_index m))
